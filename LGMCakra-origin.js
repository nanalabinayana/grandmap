...
const PAGES = [
 ...
 { name:"Study Plan 1–4", bg:FRAME[2], boxes:[
  ...
  { id:'p2a', title:'1st Term', x:83,  y:365, w:435, h:400, preset:'BIG', text:'',
    ...
    txt:{ x:40,  y:92,  size:18, lineHeight:1.30, maxWidth:373, letterSpacing:0,
          textAlign:"justify", textAlignLast:"left" }
  },
  { id:'p2b', title:'2nd Term', x:563, y:363.22, w:435.89, h:401.78, preset:'BIG', text:'',
    txt:{ x:40,  y:92,  size:18, lineHeight:1.30, maxWidth:374, letterSpacing:0,
          textAlign:"justify", textAlignLast:"left" }
  },
...
{ name:"Study Plan 5–8", bg:FRAME[3], boxes:[
  ...
  { id:'p4a', title:'2025 – 2030', x:91,  y:438, w:430, h:489, preset:'BIG', text:'', maxWords:120,
    hdr:{ abs:true, x:200, y:454, size:35, weight:300, color:"#FFFFFF",
          maxWidthAbs:430, align:"center" },
    txt:{ abs:true, x:130, y:537, size:18, weight:400, color:"#2B2B2B",
          maxWidthAbs:360, lineHeight:1.30, letterSpacing:0 }
  },
  { id:'p4b', title:'2030 – 2035', x:580, y:438, w:430, h:489, preset:'BIG', text:'', maxWords:120,
    hdr:{ abs:true, x:715, y:454, size:35, weight:300, color:"#FFFFFF",
          maxWidthAbs:430, align:"center" },
    txt:{ abs:true, x:610, y:537, size:18, weight:400, color:"#2B2B2B",
          maxWidthAbs:360, lineHeight:1.30, letterSpacing:0 }
  }
]},

{ name:"Life Grand Map 2035–Beyond", bg: FRAME[5], boxes:[
  { id:'p5a', title:'2035 – 2040', x:91,  y:332.73, w:430, h:613.82, preset:'BIG', text:'', maxWords:140,
    hdr:{ abs:true, x:200, y:454, size:35, weight:300, color:"#FFFFFF",
          maxWidthAbs:430, align:"center" },
    txt:{ abs:true, x:125, y:537, size:18, weight:400, color:"#2B2B2B",
          maxWidthAbs:380, lineHeight:1.30, letterSpacing:0 }
  },
  { id:'p5b', title:'2040 – Beyond', x:580, y:313.18, w:430, h:613.82, preset:'BIG', text:'', maxWords:140,
    hdr:{ abs:true, x:655, y:454, size:35, weight:300, color:"#FFFFFF",
          maxWidthAbs:280, align:"center" },
    txt:{ abs:true, x:610, y:537, size:18, weight:400, color:"#2B2B2B",
          maxWidthAbs:380, lineHeight:1.30, letterSpacing:0 }
  }
]},
